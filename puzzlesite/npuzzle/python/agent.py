...
class Agent:
    ...
    def nextHeuristic(self, node, node_list, dimension, goal_state, all_nodes_created, search_type):
        ...
        if row_0 > 0:
            node_down = self.move_node(node, row_0, col_0, row_0 - 1, col_0, "down", len(all_nodes_created))
        ...
        if row_0 < dimension:
            node_up = self.move_node(node, row_0, col_0, row_0 + 1, col_0, "up", len(all_nodes_created))
        ...
        if col_0 > 0:
            node_right = self.move_node(node, row_0, col_0, row_0, col_0 - 1, "right", len(all_nodes_created))
        ...
        if col_0 < dimension:
            node_left = self.move_node(node, row_0, col_0, row_0, col_0 + 1, "left", len(all_nodes_created))
